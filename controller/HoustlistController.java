...
public class HoustlistController {
	...
	public String addhouse(Model model ,String description,Houselist houselist){
	...
	public String addhouse(Model model ,String id){
		
		Houselist houselist=houselistService.findhouseid(id);
		model.addAttribute("error","该房屋id已存在");
		model.addAttribute("houselist",houselist);
		model.addAttribute("mainPage","addhouse.jsp");
		return "zuke/description";
	}
